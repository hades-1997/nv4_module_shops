...
<form class="form-horizontal" action="" enctype="multipart/form-data" method="post" id="frm-submit">
    ...
    <div class="row">
        ...
        <div class="col-sm-24 col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">{LANG.content_cat} <span class="require">(*)</span></div>
                <div class="panel-body" class="message_body" style="height:260px; overflow: auto">
                    <table class="table table-striped table-bordered table-hover">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input onchange="nv_change_catid_edit(this, {rowcontent.id})" data-label="{ROWSCAT.typeprice}" id="catright_{CATS.catid}" style="{CATS.catiddisplay}" type="radio" name="catid" title="{LANG.content_checkcat}" value="{CATS.catid}" {CATS.catidchecked}/></td>
                            </tr>
                            <!-- END: catid -->
                        </tbody>
                    </table>
...
<script type="text/javascript">
    ...
    function nv_change_catid_edit(obj, id) {
    	var cid = $(obj).val();
    	var typepriceold = $("#typepriceold").val();
    	typeprice = $(obj).data('label');
